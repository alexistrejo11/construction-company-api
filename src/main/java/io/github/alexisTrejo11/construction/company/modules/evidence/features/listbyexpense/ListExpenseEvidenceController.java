...
public class ListExpenseEvidenceController {
    private final ListExpenseEvidenceHandler handler;

    @GetMapping("/v2/api/expenses/{expenseId}/evidence")
    public ResponseEntity<ResponseWrapper<?>> list(@CurrentUser UserContext user, @PathVariable Long expenseId) {
